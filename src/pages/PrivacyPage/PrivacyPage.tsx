  ...
  return (
    <>
      <SEOHead 
        ...
        description="Learn about how we collect, use, and protect your information when you use our 10-minute grocery delivery platform."
      />
        ...
        <div className="mt-8 mb-12">
          <Card className="p-6">
            ...
            <p className="text-brand-text mb-8">
              ...
              and 10-minute grocery delivery service. By using our platform, you consent to the practices described in this policy.
            </p>
