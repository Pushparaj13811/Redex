...
const MobilePage: React.FC = () => {
    ...
    return (
        <>
            <SEOHead 
                title="Mobile App"
                description="Download our mobile app to shop for groceries with 10-minute delivery and exclusive app-only deals."
                keywords="grocery app, 10 minute delivery app, quick commerce app, grocery delivery app"
            />
            
            <div className="container mx-auto px-4 py-8">
                <PageHeader
                    title="Mobile App"
                    subtitle="Shop smarter and faster with our 10-minute delivery app"
                    breadcrumbs={[
                        { label: 'Home', href: '/' },
                        { label: 'Mobile App', href: '/mobile' }
                    ]}
                    metaTitle={`${companyInformation.name} - Mobile App`}
                    metaDescription="Download our mobile app to shop for groceries with 10-minute delivery service and exclusive app-only deals."
                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            <div className="p-8 flex flex-col justify-center">
                                ...
                                <p className="text-brand-text mb-6">
                                    Experience the convenience of our 10-minute grocery delivery right from your phone.
                                    Our app offers a seamless shopping experience with real-time order tracking and exclusive deals.
                                </p>
                        ...
                        {[
                            {
                                name: 'Aarav Sharma',
                                rating: 5,
                                review: 'This app has transformed how I shop for groceries. The 10-minute delivery is incredibly fast, and the interface is so intuitive. Highly recommend!',
                            },
                            {
                                name: 'Priya Patel',
                                rating: 5,
                                review: 'I love the exclusive app discounts! The real-time tracking is fantastic - I can see exactly when my groceries will arrive within the 10-minute window.',
                            },
                            {
                                name: 'Rajesh Gurung',
                                rating: 4,
                                review: 'Their in-house delivery team is super reliable. I\'ve never had to wait more than 10 minutes for my order. The app makes ordering incredibly simple.',
                            },
                ...
                <div className="mb-12">
                    <Card className="p-8 text-center" style={{ backgroundColor: `${theme.colors.brand.primaryLight}10` }}>
                        ...
                        <p className="text-brand-text mb-6 max-w-xl mx-auto">
                            ...
                            groceries and essentials delivered to your doorstep in just 10 minutes.
                        </p>
